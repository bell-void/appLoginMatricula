...
<div class="auth-page">
    ...
    <div class="auth-card">
        ...
        <div class="auth-tabs">
            ...
            <a href="{{ route('register') }}" class="auth-tab active">Crear Cuenta</a>
        </div>

        <div class="auth-body">

            <div class="auth-title">Únete a KRONOS</div>
            <div class="auth-desc">Crea tu cuenta institucional en minutos.</div>
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="field-group">
                    ...
                    <input
                        ...
                        required autocomplete="new-password">
                    <button type="button" class="field-toggle" onclick="togglePwd('password-confirm', this)" tabindex="-1">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8">
                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"/>
                            <circle cx="12" cy="12" r="3"/>
                        </svg>
