...
<div class="bbn-edit-container">
    ...
    <div class="edit-card">
        <form action="{{ route('matriculas.update', $matricula->id_matricula) }}" method="POST" class="edit-form">
            @csrf
            @method('PUT')
            ...
            <div class="form-group">
                ...
                <select id="id_curso" name="id_curso" required>
                    @foreach($cursos as $curso)
                        <option value="{{ $curso->id_curso }}" {{ old('id_curso', $matricula->id_curso) == $curso->id_curso ? 'selected' : '' }}>
                            {{ $curso->nombre_curso }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input type="date" id="fecha_matricula" name="fecha_matricula" value="{{ old('fecha_matricula', $matricula->fecha_matricula) }}" required>
