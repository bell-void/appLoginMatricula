...
<video class="bbn-video-bg" autoplay muted loop playsinline poster="<?php echo e(asset('images/login.png')); ?>">
    <source src="<?php echo e(asset('videos/login.mp4')); ?>" type="video/mp4">
    Tu navegador no soporta videos HTML5.
</video>
<!-- Imagen de respaldo -->
<img class="bbn-fallback-img" src="<?php echo e(asset('images/login.png')); ?>" alt="Fondo">
            ...
            <form method="POST" action="<?php echo e(route('login')); ?>" autocomplete="off">
                ...
                <div class="bbn-field">
                    ...
                    <input id="email" type="email" name="email"
                        class="bbn-input <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> bbn-input-error <?php unset($message);
...
$message = $__bag->first($__errorArgs[0]); ?>
                        <span class="bbn-error-msg"><?php echo e($message); ?></span>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                ...
                <div class="bbn-field">
                    ...
                    <input id="password" type="password" name="password"
                        class="bbn-input <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> bbn-input-error <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="bbn-field-row">
                    ...
                    <?php if(Route::has('password.request')): ?>
                        <a class="bbn-forgot" href="<?php echo e(route('password.request')); ?>">¿Olvidaste tu contraseña?</a>
                    <?php endif; ?>
                </div>
                ...
                <div class="bbn-social-row">
                    <a href="<?php echo e(url('/auth/google')); ?>" class="bbn-btn-google">
                        <img src="https://www.google.com/favicon.ico" width="16"> Google
                    </a>
                    <a href="<?php echo e(url('/auth/github/redirect')); ?>" class="bbn-btn-github">
                ...
                <p class="bbn-register-link">¿No tienes cuenta? <a href="<?php echo e(route('register')); ?>">Crear cuenta</a></p>
            </form>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\appLoginMatricula\resources\views/auth/login.blade.php ENDPATH**/ ?>